...
#feature extraction
np.save('/home/crwlia001/model_combination_results/combination_6/model_comb_6_feature_extraction.npy', feature_extraction)
...
# np.save('/scratch/crwlia001/data/densenet201_fmaps/augmented/candidate_layer_2/densenet201_cl2_aug_x_train.npy', x_train)
# np.save('/scratch/crwlia001/data/densenet201_fmaps/augmented/candidate_layer_2/densenet201_cl2_aug_x_val.npy', x_val)
# np.save('/scratch/crwlia001/data/densenet201_fmaps/augmented/candidate_layer_2/densenet201_cl2_aug_x_test.npy', x_test)

# #Save memory usage and execution time dictionaries to specified dictionary
# np.save('/home/crwlia001/model_combination_results/combination_6/densenet201_cl2_aug_feature_extraction_memory_usage.npy', feature_extraction_memory_usage)
# np.save('/home/crwlia001/model_combination_results/combination_6/densenet201_cl2_aug_feature_extraction_time.npy', feature_extraction_time)