...
#feature extraction
np.save('/home/crwlia001/model_combination_results/combination_4/model_comb_4_feature_extraction.npy', feature_extraction)
...
# testing_data = Dataset.from_tensor_slices((x_test, y_test)).cache().batch(batch_size = BATCH_SIZE).prefetch(buffer_size=AUTOTUNE)
...
# np.save('/home/crwlia001/model_combination_results/combination_4/densenet201_cl2_og_feature_extraction_memory_usage.npy', feature_extraction_memory_usage)
# np.save('/home/crwlia001/model_combination_results/combination_4/densenet201_cl2_og_feature_extraction_time.npy', feature_extraction_time)