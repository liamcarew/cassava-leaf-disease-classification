...
np.save('/scratch/crwlia001/data/densenet201_fmaps/augmented/candidate_layer_1/densenet201_cl1_aug_train.npy', x_train)
np.save('/scratch/crwlia001/data/densenet201_fmaps/augmented/candidate_layer_1/densenet201_cl1_aug_val.npy', x_val)
np.save('/scratch/crwlia001/data/densenet201_fmaps/augmented/candidate_layer_1/densenet201_cl1_aug_test.npy', x_test)

#Save memory usage and execution time dictionaries to specified dictionary
np.save('/home/crwlia001/combination_3/densenet201_feature_extraction_memory_usage_aug.npy', feature_extraction_memory_usage)
np.save('/home/crwlia001/combination_3/densenet201_feature_extraction_time_aug.npy', feature_extraction_time)