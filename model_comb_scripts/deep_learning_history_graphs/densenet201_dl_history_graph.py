...
model = build_deep_learning_model(backbone = 'DenseNet201', dropout_rate = 0.75, optimiser = 'adam', learning_rate = 0.0001, start_fine_tune_layer_name = 'pool2_conv')
...
np.save('/home/crwlia001/deep_learning_history_graphs/results/densenet201_history.npy', history.history)